...
export class JobsApi extends runtime.BaseAPI {
     ...
     * show jobs
     */
    async jobsShowRaw(requestParameters: JobsShowRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Job>> {
     ...
     * show jobs
     */
    async jobsShow(requestParameters: JobsShowRequest, initOverrides?: RequestInit): Promise<Job> {
